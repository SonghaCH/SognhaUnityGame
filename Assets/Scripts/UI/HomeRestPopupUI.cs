...
public class HomeRestPopupUI : DaniTechUIBase
{
    [Header("Settings")]
    private const string ACTIVITY_ID = "activity_HomeRest_01"; 
    ...
    private void ProcessActivityData()
    {
        ...
        // 완료 후 팝업 종료
        DaniTechUIManager.Instance.OpenMiniPopupUI("편안한 낮잠 완료!");
        DaniTechUIManager.Instance.CloseHomeRestPopupUI();
    }
}
