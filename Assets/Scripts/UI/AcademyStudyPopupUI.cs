...
public class AcademyStudyPopupUI : DaniTechUIBase
{
    [Header("Settings")]
    private const string ACTIVITY_ID = "activity_Academy_01"; // 엑셀의 학원 ID

    [Header("Animation")]
    [SerializeField] private Animator animator;
    [SerializeField] private float animationDuration = 15.0f; // 애니메이션 길이에 맞춰 조정하세요
    ...
    private IEnumerator PlayAnimationAndFinish()
    {
        ...
        if (animator != null)
        {
            animator.Play("StudyWork_0"); // 현재 애니메이터 이름과 일치시키세요
        }
    ...
    private void ProcessActivityData()
    {
        ...
        // 완료 후 팝업 종료
        DaniTechUIManager.Instance.OpenMiniPopupUI("공부 완료!");
        DaniTechUIManager.Instance.CloseAcademyStudyPopupUI();
    }
}