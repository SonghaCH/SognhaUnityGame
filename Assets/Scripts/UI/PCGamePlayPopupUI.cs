...
public class PCGamePlayPopupUI : DaniTechUIBase
{
    [Header("Settings")]
    private const string ACTIVITY_ID = "activity_GameRoom_01"; 
    ...
    private IEnumerator PlayAnimationAndFinish()
    {
        ...
        if (animator != null)
        {
            animator.Play("qiyana_triplekill_sprite_sheet_24f_0"); // 현재 애니메이터 이름과 일치시키세요
        }
    ...
    private void ProcessActivityData()
    {
        ...
        // 완료 후 팝업 종료
        DaniTechUIManager.Instance.OpenMiniPopupUI("즐거운 게임 완료!");
        DaniTechUIManager.Instance.ClosePCGamePlayPopupUI();
    }
}
